    ...
    <div class="chat-window is-hidden" id="chatWindow">
        ...
        <div class="chat-footer">
            <div class="chat-input-wrapper">
                <input class="chat-input" type="text" placeholder="Type your message..." id="messageInput" autocomplete="off">
                <button class="chat-send-btn" id="sendMessage" aria-label="Send message">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
